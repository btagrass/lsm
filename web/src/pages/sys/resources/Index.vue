  ...
  <div>
    ...
    <div class="row">
      <el-table ref="table" :data="data.records" :tree-props="{ children: 'children' }" border default-expand-all
        ...
        <el-table-column label="编码" prop="id" width="160px"></el-table-column>
        ...
        <el-table-column label="操作" width="150px" align="center">
          <template #default="scope">
            ...
            <el-button type="primary" circle icon="edit" title="编辑" @click="open(scope.row.id, 'Edit', scope.row.parentId)"></el-button>
