      ...
      <el-table-column label="操作" width="150">
        <template #default="scope">
          <el-button-group>
            ...
            <el-button type="warning" icon="Setting" title="资源"
              @click="open(RoleResource, { id: scope.row.id })"></el-button>
          </el-button-group>
        </template>
      </el-table-column>
    </el-table>
...
const { table, params, data, list, remove, select } = useList("/mgt/sys/roles")
</script>
